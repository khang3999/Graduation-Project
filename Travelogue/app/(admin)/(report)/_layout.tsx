...
import { Entypo, EvilIcons, Fontisto, MaterialCommunityIcons, MaterialIcons } from '@expo/vector-icons';
  ...
  return (
    <Tabs
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Đánh giá',
          tabBarIcon: ({ color }) => <FontAwesome name="star-o" size={28} color={color} />,
          headerShown: false
        }}
      />
