    ...
    <View style={styles.container}>
      ...
      <Animated.ScrollView
        ...
        <View style={{
          ...
          <View style={{ position: 'absolute', backgroundColor: 'white', padding: 20, bottom: 0, width: '100%', borderTopLeftRadius: 30, borderTopRightRadius: 30 }}>
            {/* New tours list */}
...
const styles = StyleSheet.create({
  ...
  bannerContentBackgroundOverPlay: {
    ...
    top: 0,
    left: 0,
    backgroundColor: 'rgba(5, 26, 9, 0.9)'
  },
