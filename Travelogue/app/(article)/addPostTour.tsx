...
import { Checkbox, Modal, Provider, RadioButton } from "react-native-paper";
import {
  database,
  onValue,
  ref,
...
const AddPostTour = () => {
  ...
  //     if ((account?.accumulate ?? 0) < packageData[0].price) {
  //       Alert.alert(
  //         "Thông báo",
  //         "Bạn không đủ số dư trong tài khoản để đăng bài",
  //         [
  //           {
  //             text: "Nạp tiền",
  ...
  //     }
  //   }
  // }, [packageData, account?.accumulate]);
        ...
        (account?.accumulate ?? 0) >=
          ...
          >
            <View style={styles.container}>
              ...
              <View
                style={[styles.separator, { marginTop: -10, marginBottom: 0 }]}
              />
              <ScrollView>
                {/* Check in */}
