          ...
          <View style={styles.wrapTopTrending}>
            ...
            >
              <View style={styles.rankImageContainer}>
                <Image
                  source={{
                    uri: toursData?.[1]?.thumbnail ?? "https://mediatech.vn/assets/images/imgstd.jpg",
                  }}
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center' }}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                ...
                >
                  {formatNumberShort(toursData?.[1]?.scores)}
          ...
          <View style={styles.wrapTopTrending}>
            <View style={styles.rankCircleBig}>
              <View style={styles.rankImageContainer}>
                <Image
                  source={{
                    uri: toursData?.[0]?.thumbnail ?? "https://mediatech.vn/assets/images/imgstd.jpg",
                  }}
                  style={styles.rankImageFill}
                />
              </View>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center' }}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                ...
                >
                  {formatNumberShort(toursData?.[0]?.scores)}
                </Text>
          ...
          <View style={styles.wrapTopTrending}>
            ...
            >
              <View style={styles.rankImageContainer}>
                <Image
                  source={{
                    uri: toursData?.[2]?.thumbnail ?? "https://mediatech.vn/assets/images/imgstd.jpg",
                  }}
                  style={styles.rankImageFill}
                />
              </View>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center' }}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <Text
                  style={[styles.levelText,]}
                >
                  {formatNumberShort(toursData?.[2]?.scores)}
                </Text>
