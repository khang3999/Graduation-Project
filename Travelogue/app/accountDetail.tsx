...
import HeaderProfileGuest from "@/components/profile/HeaderProfileGuest";
  ...
  export default function ProfileScreen() {
    ...
    return (
      <>
        <HeaderProfileGuest onModalOpen={openSearchModal} onModalClose={closeSearchModal} handleSearch={handleSearch} isSearched={false}/>
